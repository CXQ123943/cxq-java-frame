...
class RestTemplateTest {
    ...
    void getForObject() {
        ...
        // with k-v param...
        System.out.println(restTemplate.getForObject(baseUrl + "?name=steven", String.class));

        // with array param...
        System.out.println(restTemplate.getForObject(baseUrl + "?name={name}", String.class, "steven"));

        // with map param...
        Map<String, Object> params = new HashMap<>(1);
        params.put("name", "steven");
    ...
    void getForEntity() {
        ...
        // with k-v param...
        System.out.println(restTemplate.getForEntity(baseUrl + "?name=steven", String.class));

        // with array param...
        System.out.println(restTemplate.getForEntity(baseUrl + "?name={name}", String.class, "steven"));
    ...
    void postForObject() {
        ...
        // with k-v param...
        System.out.println(restTemplate.postForObject(baseUrl + "?name=steven", null, String.class));

        // with array param...
        System.out.println(restTemplate.postForObject(baseUrl + "?name={name}", null, String.class, "steven"));
    ...
    void postForEntity() {
        ...
        // with k-v param...
        System.out.println(restTemplate.postForEntity(baseUrl + "?name=steven", null, String.class));

        // with array param...
        System.out.println(restTemplate.postForEntity(baseUrl + "?name={name}", null, String.class, "steven"));
    ...
    @Test
    void redirect() {
        String baseUrl = "http://127.0.0.1:8080/api/rest-template/redirect?name=steven";
